...
export default function PhotoExportSubpage() {
  ...
  return (
    <div className="bg-background flex min-h-screen flex-col p-4 px-4 py-2">
      {/* 工具栏——原错误地嵌套在 AlertDialog 内部（AlertDialogContent 的兄弟节点）。
          现移到外层：AlertDialog（Radix Root 不渲染 DOM）内联到导出按钮位置，
          仅包裹 AlertDialogTrigger + AlertDialogContent，保持 flex 布局不变。 */}
