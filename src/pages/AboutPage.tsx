          ...
          <div className="flex flex-col items-center justify-center border-b bg-slate-50/80 p-8 md:border-b-0 md:border-r dark:bg-slate-900/50">
            ...
            <div className="space-y-2 text-center text-xs text-slate-400">
              ...
              <button
                ...
                className="mt-2 inline-flex items-center gap-1 rounded-full bg-slate-900 px-3 py-1 text-[11px] font-semibold text-white shadow-sm ring-1 ring-slate-900/10 transition hover:bg-slate-800 dark:bg-slate-100 dark:text-slate-900 dark:ring-slate-50/20 dark:hover:bg-white"
              >
                <Github className="h-3.5 w-3.5" />
                <span>{t("about.githubProfile") || "作者主页 / GitHub"}</span>
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-col bg-white dark:bg-slate-950">
            ...
            <CardContent className="flex flex-1 flex-col gap-6 pt-3">
              ...
              <div className="space-y-4">
                ...
                {/* 反馈入口：醒目卡片置于右侧内容区中部 */}
                <div className="rounded-xl border border-emerald-200/70 bg-emerald-50 px-4 py-3 text-emerald-900 shadow-sm dark:border-emerald-900/60 dark:bg-emerald-950/50 dark:text-emerald-100">
                ...
                <div className="flex items-center gap-2 rounded-md border bg-slate-50 px-3 py-2 text-xs text-slate-600 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300">
                  ...
                  <button
                    ...
                    className="ml-auto inline-flex max-w-[320px] items-center gap-1 truncate text-blue-600 hover:underline dark:text-blue-400"
                  >
                    <span>github.com/SMARK2022/electron-media-toolbox</span>
                    <ExternalLink className="h-3 w-3" />
                  </button>
                </div>

                {/* 致谢信息提前，避免与版本检查器同一行冲突 */}
