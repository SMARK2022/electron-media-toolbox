  ...
  en: {
    translation: {
      photoContext: {
        ...
        skipConfirmLabel: "Do not ask again (use with caution)",
        infoTitle: "Photo details",
        infoDescription: "All available metadata for this photo.",
        infoEmpty: "No extra metadata available.",
        infoBasic: "Basic info",
        infoExif: "EXIF",
        menu: {
          groupOpen: "Open",
          groupEdit: "Edit",
      ...
      photoDetailsTable: {
        ...
        filePath: "File path",
        fileSize: "File size",
        fileInfo: "Shooting info",
        fileDate: "Capture date",
        similarity: "In-group similarity",
        iqaScore: "IQA score",
  ...
  zh: {
    translation: {
      photoContext: {
        ...
        confirmDeleteDescription: "将从磁盘中永久删除该文件，此操作不可撤销。",
        confirmDeleteButton: "删除",
        skipConfirmLabel: "谨慎选择：不再提醒",
        infoTitle: "照片详细信息",
        infoDescription: "下方列出了该照片目前可用的所有元数据信息。",
        infoEmpty: "暂无可用元数据信息。",
        infoBasic: "基础信息",
        infoExif: "EXIF 信息",
        menu: {
